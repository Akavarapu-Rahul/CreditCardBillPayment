                            ...
                            <div className="collapse navbar-collapse" id="navbarNavDropdown" style={{ paddingRight: "15px" }}>
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link style={{ fontSize: '18px', color: 'white', paddingRight: '20px' }} className="nav-a active mr-3" aria-current="page" to="/AdminHome" style={{ fontSize: '15px' }}>Home</Link>
                                    </li>
                    ...
                    <nav className="navbar navbar-expand-md navbar-dark bg-dark">
                        <div className="container-fluid">
                            ...
                            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                                <ul className="navbar-nav">
                                    <li className="nav-item">
                                        <Link style={{ fontSize: '18px', color: 'white', paddingRight: '20px' }} className="nav-a active mr-3" aria-current="page" to="/CustomerHome" style={{ fontSize: '15px' }}>Home</Link>
                                    </li>
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenua">
                                            <li><Link className="dropdown-item" style={{ fontSize: '15px' }} to="/viewCustomerDetails">View Customer Details</Link></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li className="nav-item dropdown">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenua">
                                            <li><Link className="dropdown-item" style={{ fontSize: '15px' }} to="/addPayment">Pay Bill</Link></li>
                                            <li><Link className="dropdown-item" style={{ fontSize: '15px' }} to="/getCustomerPayments">View Payments</Link></li>
                                            <li><Link className="dropdown-item" style={{ fontSize: '15px' }} to="/getPendingBills">Get Pending Bills</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nav-item dropdown">
                                        <a style={{ fontSize: '15px', color: 'white', paddingRight: '20px' }} className="nav-a dropdown-toggle" href="#" id="navbarDropdownMenua" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenua">
                                            <li><Link className="dropdown-item" style={{ fontSize: '15px' }} to="/getHistoryTransaction">Transaction History</Link></li>
                                        </ul>
                                    </li>
                                    <li className="nav-item dropdown">
                                        <a style={{ fontSize: '15px', color: 'white', paddingRight: '20px' }} className="nav-a dropdown-toggle" href="#" id="navbarDropdownMenua" role="button" data-bs-toggle="dropdown" aria-expanded="false">
