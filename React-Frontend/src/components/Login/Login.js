                            ...
                            <div className="card-body">
                                <form name="form" onSubmit={this.loginUser} noValidate>
                                    <div className="form-group">
                                        <i className="glyphicon glyphicon-user mr-2" style={{ color: 'white'}}></i>
                                    ...
                                    <div className="form-group">
                                        <i className="fas fa-key mr-2" style={{ color: 'white'}}></i>
                                    ...
                                    <div className="form-group">
                                        <i className="glyphicon glyphicon-lock mr-2" style={{ color: 'white'}}></i>
