...
import GetHistoryTransaction from './components/Transaction/GetHistoryTransaction';
import GetCustomerCreditCard from './components/CreditCard/GetCustomerCreditCard';
import ViewCustomerDetails from './components/Customer/ViewCustomerDetails';
import GetCustomerPayments from './components/Payment/GetCustomerPayments';
import GetPendingBills from './components/Payment/GetPendingBills';
    ...
    <BrowserRouter>
      <div className='App'>
        <Switch>
          ...
          <Route path="/getHistoryTransaction" component={GetHistoryTransaction}></Route>
          <Route path="/getCustomerCreditCard" component={GetCustomerCreditCard}></Route>
          <Route path="/viewCustomerDetails" component={ViewCustomerDetails}></Route>
          <Route path="/getCustomerPayments" component={GetCustomerPayments}></Route>
          <Route path="/getPendingBills" component={GetPendingBills}></Route>
