...
public class PaymentController {
	...
	@PostMapping("/pay")
	public ResponseEntity<Payments> paybill(@Valid @RequestBody Payment pay)throws PaymentException, CreditCardException, StatementException {
		logger.info("Called POST mapping paybill() method");
		Payment payment=paymentService.payForCreditCard(pay,pay.getCard().getCardNumber());
		Payments payment1=new Payments(payment);
